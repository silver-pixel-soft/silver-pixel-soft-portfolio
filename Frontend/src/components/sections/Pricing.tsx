      ...
      <div className="grid md:grid-cols-3 gap-8">
        {plans.map((plan, index) => (
          <div
            ...
            className={`relative p-8 rounded-3xl border flex flex-col h-full bg-neutral-900 ${
              plan.popular ? 'border-sky-500 shadow-[0_0_40px_rgba(14,165,233,0.15)] ring-1 ring-sky-500/50 scale-105 z-10' : 'border-white/10'
            }`}
          >
            {plan.popular && (
